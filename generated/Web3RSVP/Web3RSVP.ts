...
export class CreateNeRSVPCall extends ethereum.Call {
  get inputs(): CreateNeRSVPCall__Inputs {
    return new CreateNeRSVPCall__Inputs(this);
  }

  get outputs(): CreateNeRSVPCall__Outputs {
    return new CreateNeRSVPCall__Outputs(this);
  }
}

export class CreateNeRSVPCall__Inputs {
  _call: CreateNeRSVPCall;

  constructor(call: CreateNeRSVPCall) {
    this._call = call;
  }
...
export class CreateNeRSVPCall__Outputs {
  _call: CreateNeRSVPCall;
